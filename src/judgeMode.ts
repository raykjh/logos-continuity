...
export const JUDGE_MODE_STEPS: JudgeStep[] = [
  ...
  },
  {
    ...
    sampleInput: "Atlas 결제 모듈 작업 이어가자"
  },
  {
    id: "safe-classification",
    target: "intake",
    eyebrow: "00:43 · SAFE ROUTING",
    ...
    sampleInput: "베타 출시를 다음 주로 앞당기는 것도 검토해보자."
  },
  {
    id: "conflict-resolution",
    target: "conflict",
    eyebrow: "01:05 · CONFLICT",
    ...
    sampleInput: "스테이징 검증을 생략하고 모든 사용자에게 즉시 배포한다."
  },
  {
    id: "state-operations",
    target: "operations",
    eyebrow: "01:27 · OPERATIONS",
